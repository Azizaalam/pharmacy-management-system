...
http://127.0.0.1:8000
```
11. Enjoy :).Report bugs,features and also send your pull requests.
...
![Admin](screenshots/admin/dashboard.png?raw=true "Dashboard page")

![Admin](screenshots/admin/categ.png?raw=true "Categ page")

![Admin](screenshots/admin/Supplier.png?raw=true "Supplier page")

![Admin](screenshots/admin/Purchases.png?raw=true "Purchases page")

![Admin](screenshots/admin/Products.png?raw=true "Products page")

![Admin](screenshots/admin/Sales.png?raw=true "Sales page")

![Admin](screenshots/admin/PR.png?raw=true "PR page")

![Admin](screenshots/admin/SR.png?raw=true "SR page")

![Admin](screenshots/admin/Permissions.png?raw=true "Permissions page")

![Admin](screenshots/admin/Role.png?raw=true "Role page")

![Admin](screenshots/admin/Users.png?raw=true "Users page")

![Admin](screenshots/admin/Profile.png?raw=true "Profile page")

Manual Add, Edit and Delete Data:

![Admin](screenshots/admin/add.png?raw=true "add page")

![Admin](screenshots/admin/edit.png?raw=true "edit page")

![Admin](screenshots/admin/Delete.png?raw=true "Delete page")

# User Portal

![User](screenshots/user/Dash.png?raw=true "Dashbaord page")

![User](screenshots/user/SR.png?raw=true "SR page")

![User](screenshots/user/PR.png?raw=true "PR page")

![User](screenshots/user/Profile.png?raw=true "Profile page")
